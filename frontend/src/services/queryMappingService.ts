...
const getPropertyDemoValues = (property: string): GraphOption[] => {
  ...
  if (property === "created_in" || property === "located_in") {
    // Dados mais realistas baseados nos países da América Latina (44 países)
    return [
      { value: "Argentina", label: "Argentina", count: 3, type: "value" },
      { value: "Belize", label: "Belize", count: 1, type: "value" },
      { value: "Bolivia", label: "Bolivia", count: 2, type: "value" },
      { value: "Brazil", label: "Brazil", count: 15, type: "value" },
      { value: "Chile", label: "Chile", count: 4, type: "value" },
      { value: "Colombia", label: "Colombia", count: 6, type: "value" },
      { value: "Costa Rica", label: "Costa Rica", count: 2, type: "value" },
      { value: "Cuba", label: "Cuba", count: 1, type: "value" },
      { value: "Dominica", label: "Dominica", count: 1, type: "value" },
      {
      ...
      { value: "Ecuador", label: "Ecuador", count: 3, type: "value" },
      { value: "El Salvador", label: "El Salvador", count: 1, type: "value" },
      {
        value: "French Guiana",
        label: "French Guiana",
        count: 1,
      ...
      { value: "Grenada", label: "Grenada", count: 1, type: "value" },
      { value: "Guatemala", label: "Guatemala", count: 2, type: "value" },
      { value: "Guyana", label: "Guyana", count: 1, type: "value" },
      { value: "Haiti", label: "Haiti", count: 1, type: "value" },
      { value: "Honduras", label: "Honduras", count: 1, type: "value" },
      { value: "Jamaica", label: "Jamaica", count: 1, type: "value" },
      { value: "Mexico", label: "Mexico", count: 8, type: "value" },
      { value: "Nicaragua", label: "Nicaragua", count: 1, type: "value" },
      { value: "Panama", label: "Panama", count: 1, type: "value" },
      { value: "Paraguay", label: "Paraguay", count: 2, type: "value" },
      { value: "Peru", label: "Peru", count: 5, type: "value" },
      { value: "Puerto Rico", label: "Puerto Rico", count: 1, type: "value" },
      {
      ...
      { value: "Saint Lucia", label: "Saint Lucia", count: 1, type: "value" },
      {
      ...
      { value: "Suriname", label: "Suriname", count: 1, type: "value" },
      {
      ...
      { value: "Uruguay", label: "Uruguay", count: 2, type: "value" },
      { value: "Venezuela", label: "Venezuela", count: 3, type: "value" },
      { value: "Anguilla", label: "Anguilla", count: 1, type: "value" },
      {
      ...
      { value: "Aruba", label: "Aruba", count: 1, type: "value" },
      { value: "Bahamas", label: "Bahamas", count: 1, type: "value" },
      { value: "Barbados", label: "Barbados", count: 1, type: "value" },
      { value: "Bonaire", label: "Bonaire", count: 1, type: "value" },
      {
      ...
      { value: "Curaçao", label: "Curaçao", count: 1, type: "value" },
      {
      ...
      { value: "Martinique", label: "Martinique", count: 1, type: "value" },
      { value: "Montserrat", label: "Montserrat", count: 1, type: "value" },
      {
