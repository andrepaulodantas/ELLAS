...
export default function BuscaTwoPage() {
  return (
    <>
      <Helmet>
        <title>ELLAS</title>
                  ...
                  {[...Array(3)].map((_, index) => (
                    <TabPanel key={`tab-panel${index}`} className="items-center w-full absolute">
                      <div className="flex flex-col items-center justify-start w-full mt-[-2px]">
                        <div className="flex flex-col items-center justify-start w-full mb-[21px] gap-[23px]">
                          <div className="h-[2px] w-full bg-deep_orange-200" />
                          <div className="flex flex-col items-start justify-start w-[95%] md:w-full gap-[22px]">
                            <Text size="3xl" as="p" className="ml-1 md:ml-0 text-center">
                              Quais e quantas iniciativas são realizadas por país?
                            </Text>
                            <div className="flex flex-col items-end justify-center w-full gap-[87px]">
