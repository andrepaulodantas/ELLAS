  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      ...
      <main className="pt-20 p-5 w-full flex flex-col items-center justify-start text-center">
        <Heading as="h1" size="xl" className="text-2xl font-bold my-5">FAQ</Heading>
        <Text className="mb-5">Aqui estão algumas perguntas frequentes para ajudar você a entender melhor nossos serviços e iniciativas.</Text>
        <Text className="mb-5">Q: Como posso participar? A: Você pode participar através de doações, voluntariado, ou participando de eventos.</Text>
      </main>
