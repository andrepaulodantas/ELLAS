  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      ...
      <main className="pt-20 p-5 w-full flex flex-col items-center justify-start text-center">
        <Heading as="h1" size="xl" className="text-2xl font-bold my-5">Apoie Ellas</Heading>
        <Text className="mb-5">Saiba como você pode ajudar a promover a equidade de gênero na tecnologia.</Text>
        <Text className="mb-5">Contribua com doações, participe de eventos, ou torne-se um voluntário.</Text>
      </main>
